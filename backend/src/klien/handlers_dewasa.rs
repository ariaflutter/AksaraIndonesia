...
pub struct AuthContext {
    pub user_id: i32,
    pub user_role: crate::types::UserRole,
...
impl AuthContext {
    ...
    pub async fn new(pool: &PgPool, klien_id: i32, claims: &Claims) -> Result<Self, StatusCode> {
        ...
        Ok(Self {
            ...
            user_bapas_id: claims.unit_kerja_id,
...
pub async fn update_layanan_integrasi_dewasa(
    ...
    if auth_context.user_role != crate::types::UserRole::SuperAdmin && !auth_context.is_in_same_bapas() {
...
pub async fn delete_layanan_integrasi_dewasa(
    ...
    if auth_context.user_role != crate::types::UserRole::SuperAdmin && auth_context.user_role != crate::types::UserRole::AdminBapas {
